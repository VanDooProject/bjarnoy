...
When writting code we try to write it in a clean way:
 * variables, fields, classes, methods and attributes have meaningfull names -> no comments needed
 * a class, method, ... has only one purpose -> single responsibility
    ...
    * classes over 300 linese are maybe doing more than only one thing
    * don't use partial classes in C#

# Setup your maschine - Install needed tools

## Visual Studio Code
This is the main IDE and can be used for Backend and Frontend Development.

When you first open the directory of the project you will be propted to install the recommended Workspace plugins. Do this for the best experience.
...
for just commiting and pushing in this project I use Visual Studio Code directly.
...
# Workflow
 ...
 3. checkout the correct branch locally and work there; push regullarly to check if everything builds
 4. when done, remove the WIP prefix on the mergerequest and tell me to merge it after a review; Merges are only done if CI is green!
