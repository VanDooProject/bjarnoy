        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockWood = table.Column<double>(type: "REAL", nullable: false),
                    StockStone = table.Column<double>(type: "REAL", nullable: false),
                    StockGrain = table.Column<double>(type: "REAL", nullable: false),
                    StockSilver = table.Column<double>(type: "REAL", nullable: false),
                    RateWood = table.Column<double>(type: "REAL", nullable: false),
                    RateStone = table.Column<double>(type: "REAL", nullable: false),
                    RateGrain = table.Column<double>(type: "REAL", nullable: false),
                    RateSilver = table.Column<double>(type: "REAL", nullable: false),
                    CapacityWood = table.Column<double>(type: "REAL", nullable: false),
                    CapacityStone = table.Column<double>(type: "REAL", nullable: false),
                    CapacityGrain = table.Column<double>(type: "REAL", nullable: false),
                    CapacitySilver = table.Column<double>(type: "REAL", nullable: false),
                    SettledAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    FoundedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletesAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
