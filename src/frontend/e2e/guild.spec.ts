...
test('the Alliance nav link opens the guild view', async ({ page }) => {
  await page.goto('/');
...
test('demo mode has no live world, so the guild view shows its hint instead of erroring', async ({ page }) => {
