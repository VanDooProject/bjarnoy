...
// MapView.vue and RealmPanel.vue/ArmyPanel.vue's --hud-inset-bottom read it
// so their own layout stays clear of the bar regardless of its current
// height, instead of assuming a fixed 64px. Desktop's bar never actually
// changes height, so this is a no-op there in practice.
